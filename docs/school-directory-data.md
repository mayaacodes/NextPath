...
Retrieval attempted: **2026-09-17** (UTC) from the cloud-agent environment.

> Note: DNS/network policy in this sandbox blocked direct access to NCES/ArcGIS hosts during this PR, so a full production refresh could not be executed here. The committed `docs/data/school-directory.json` was generated from local fixtures for offline validation only.
...
Offline fixture build (used in this PR):
